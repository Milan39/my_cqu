...
import 'package:my_cqu/feature/auth/cubit/screen_cubit/screen_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => sl<ScreenCubit>()),
      ],
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomTextField(
                                ...
                                title: "Password",
                                hasAstric: true,
                                obscureText: screenState.hidePassword,
                                validator: FormBuilderValidators.compose([
                                  FormBuilderValidators.required(),
                                ...
                                decoration: passwordFieldDecoration(
                                  suffixIcon: VisibilityIconButton(
                                    ...
                                    isVisible: screenState.hidePassword,
                                  ),
                                  radius: 60.sp,
